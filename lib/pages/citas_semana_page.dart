...
class CitasSemanaPage extends StatefulWidget {
  const CitasSemanaPage({Key? key}) : super(key: key);

  @override
  State<CitasSemanaPage> createState() => _CitasSemanaPage();
}

class _CitasSemanaPage extends State<CitasSemanaPage> {
  ...
  void _obtenerCitas () async {
    ...
    _streamCitas = _firebaseService.consultarCitasSemana();
